...
collection of different wrapper functions in R, that
...
\item
  offers the possibility to use parallelised processing (using
  \texttt{furrr} package)
\end{itemize}
...
alternative to our work besides some minor differences, there is
