...
\NormalTok{                  ,}\FunctionTok{c}\NormalTok{(}\StringTok{"mu"}\NormalTok{, }\FloatTok{0.5}\NormalTok{, }\DecValTok{1}\NormalTok{, }\FloatTok{0.25}\NormalTok{))}
...
\FunctionTok{data\_generation}\NormalTok{(}\AttributeTok{simulation=}\NormalTok{rnorm, }\AttributeTok{grid=}\NormalTok{grid2)}
\end{Highlighting}
\end{Shaded}
