...
a reminder, those simulations ran on MacBook Air 10 with total 8 cores.
Execution times of the simulation might differ on other computers.
...
\item
  Density of MSE of /beta2 in OLS and GLS simulations.
\end{itemize}
