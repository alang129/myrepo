...
\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#?draw of
data points? The draw of data points for each row of the parameter grid
gets stored as a seperate element in a list.
...
=======
map() & future\_map & \(n \leq 1\) \\
map2() & future\_map2 & \(n \leq 2\) \\
pmap & future\_pmap & otherwise \\
>>>>>>> da014b0c1fed64157a0e64de6e95c1fefb435f68
\bottomrule()
\end{longtable}
...
computing time. In that case, Parallel processing is useful. Processes
are parallel if at any time both of them are simultaneously executed,
for instance, processes are executed by separate, distributed processors
interconnected by communication channel\autocite{Czech_2017}.
\texttt{data\_generation\_parallelised} uses \texttt{furrr\_options()}
that is a parallel processing function in \texttt{furrr} package.
...
\textbf{\texttt{summary\_function} Example:} \texttt{summary\_data}
shows \texttt{mean} of the generated data which is normally distributed
and corresponds given with the n, \(\mu\) and the standard deviation
...
\FunctionTok{head}\NormalTok{(summary\_data,}\DecValTok{2}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
with the parameter grid into one data frame.
\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\# data wrangling
processes?? This way to store the data allows users to apply further
data wrangling processes. A multi-dimensional array is more suitable for
printing the output in a tidy and clear way.
\texttt{create\_array\_function()} takes all relevant data from the
previous steps (parameter grid and the results of the Monte Carlo
...
\NormalTok{                                      , simulation }\CommentTok{\#data generation}
...
\NormalTok{  raw\_data }\OtherTok{\textless{}{-}} \FunctionTok{data\_generation}\NormalTok{(simulation, grid) }\CommentTok{\#Step 2: simulate data}
...
\NormalTok{  comb }\OtherTok{\textless{}{-}} \FunctionTok{cbind}\NormalTok{(grid, summary) }\CommentTok{\#Step 4: Combine results with parameters}
...
\begin{Shaded}
\begin{Highlighting}[]
\DocumentationTok{\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\# need to reduce a range of grid and nrep?}
...
Through \texttt{create\_array\_function}, users can obtain all
combinations corresponding each grid, the number of repetition, and the
summary function that users require, such as \texttt{mean} in this case.
...
## 
<<<<<<< HEAD
##  Execution Time of Monte Carlo Simulation 0.3788722 secs 
=======
##  Execution Time of Monte Carlo Simulation 0.244014 secs 
>>>>>>> da014b0c1fed64157a0e64de6e95c1fefb435f68
## 
...
## 
<<<<<<< HEAD
##  Execution Time of Monte Carlo Simulation 0.213414 secs 
=======
##  Execution Time of Monte Carlo Simulation 0.1450081 secs 
>>>>>>> da014b0c1fed64157a0e64de6e95c1fefb435f68
## 
##  Name of The Class : Eco
\end{verbatim}
...
## 
<<<<<<< HEAD
##  Execution Time of Monte Carlo Simulation 57.62402 secs 
=======
##  Execution Time of Monte Carlo Simulation 33.83294 secs 
>>>>>>> da014b0c1fed64157a0e64de6e95c1fefb435f68
## 
##  Name of The Class : Eco
\end{verbatim}
...
## 
<<<<<<< HEAD
##  Execution Time of Monte Carlo Simulation 52.99871 secs 
=======
##  Execution Time of Monte Carlo Simulation 34.56598 secs 
>>>>>>> da014b0c1fed64157a0e64de6e95c1fefb435f68
## 
##  Name of The Class : Eco
\end{verbatim}
...
\toprule()
& Öcal Kaptan & Sunyoung Ji & Alexander Langnau \\
\midrule()
\endhead
Planning & 0 & 0 & 0 \\
Create\_grid & 0 & 0 & 0 \\
