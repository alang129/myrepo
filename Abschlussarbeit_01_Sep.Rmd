...
```
The total execution time of OLS simulation is 0.25 seconds when only one core is used.
...
ols <- main_function(parameters = param_list,
                     ...
                     cores=4)
```
The total execution time of OLS simulation is 1.66 seconds when four cores are used.
